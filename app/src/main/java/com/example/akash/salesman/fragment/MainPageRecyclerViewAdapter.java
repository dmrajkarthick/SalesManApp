...
class MainPageRecyclerViewAdapter extends RecyclerView.Adapter<MainPageRecyclerViewAdapter.ItemViewHolder>{

    private final List<ContentItem> mValues;
    private final MainContentFragment.OnMainContentFragmentInteractionListener mListener;
    Toolbar toolbar;
    ...
    public MainPageRecyclerViewAdapter(List<ContentItem> items, MainContentFragment.OnMainContentFragmentInteractionListener listener) {
